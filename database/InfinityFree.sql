-- ============================================================
--  Amrit Teerth — database schema (InfinityFree / shared hosting)
--
--  How to import:
--    1. hPanel par MySQL database banao (jaise: if0_12345_sacredpath).
--    2. phpMyAdmin kholo aur LEFT side se WAHI database select karo.
--    3. "SQL" tab > yeh poori file paste karo (ya "Import" tab se upload karo) > Go.
--
--  NOTE: Isme jaan-bujhkar `CREATE DATABASE` / `USE` lines NAHI hain —
--  shared hosting par database pehle se bana hota hai, isliye sirf tables
--  banti hain. Apni di hui DB select karke import karna zaroori hai.
-- ============================================================
